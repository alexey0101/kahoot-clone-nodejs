...
socket.on('showGameData', data => {
    ...
    for (var i = 0; i < questionNum; i++) {
        ...
        answer1Field.setAttribute('id', String(i + 1) + "a1");
        answer1Field.setAttribute('type', 'text');
        answer2Field.setAttribute('id', String(i + 1) + "a2");
        answer2Field.setAttribute('type', 'text');
        answer3Field.setAttribute('id', String(i + 1) + "a3");
        answer3Field.setAttribute('type', 'text');
        answer4Field.setAttribute('id', String(i + 1) + "a4");
        answer4Field.setAttribute('type', 'text');
        correctField.setAttribute('id', 'correct' + String(i + 1));
...
socket.emit('getGameData', quizId);
